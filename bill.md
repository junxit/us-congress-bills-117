...
> To direct the Secretary of Defense to develop a plan to establish the Minority Institute for Defense Research, and for other purposes.

## § 1. Short title

This Act may be cited as the “Building Equitable Access to Contribute to Our National Security Act of 2021” or the “BEACON Act of 2021”.

## § 2. Minority Institute for Defense Research
...
- **(d)** *Definitions* In this section:
  ...
  - **(3)** The term leading minority institution means a minority institution identified (pursuant to the assessment required under subsection (a)(2)(B)) as being in the top 20 percent of all such institutions with respect to providing essential engineering, research, or development capability.
  ...
  - **(7)** The term University Affiliated Research Center means a research organization within an institution of higher education that—
...
## § 3. Subcontract requirements for minority institutions

- **(a)** *In general* Section 2304 of title 10, United States Code, is amended by adding at the end the following new subsection:
  > - **(m)**
  >   - **(1)** The head of an agency shall require that a contract awarded to an educational institution pursuant to subsection (c)(3)(B) includes a requirement to subcontract with one or more minority institutions for a total amount of not less than 5 percent of the amount awarded in the contract.

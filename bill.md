...
- **(a)** *In general* Chapter 44 of title 18, United States Code, is amended by adding at the end the following:
  ...
  >     - **(B)**
  >       - **(i)** if the respondent may lawfully own and possess firearms and ammunition, notify the respondent that the respondent may retrieve each firearm, ammunition, or permit surrendered by or removed from the respondent under subsection (f); or

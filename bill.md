...
- **(1)** in subsection (a)—
  - **(A)** in paragraph (4)(B)—
    ...
    - **(iv)** by inserting after clause (xxvii) the following:
      > - **(xxviii)** Installation of infrastructure improvements, including sidewalks, crosswalks, signage, and bus stop shelters or protected waiting areas.
  ...
  - **(C)** by inserting after paragraph (9) the following:
    ...
    >     - **(iii)** supports Safe Routes to School non-infrastructure projects, as described in section 211(e).

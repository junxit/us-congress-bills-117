...
## § 2. Discrimination by abortion against an unborn child on the basis of Down syndrome prohibited
...
- **(a)** *In general* Chapter 13 of title 18, United States Code, is amended by adding at the end the following:
  ...
  >   - **(2)** *Down syndrome* The term Down syndrome means a chromosomal disorder associated with—
  >     - **(A)** an extra copy of the chromosome 21, in whole or in part; or
  ...
  >       - **(i)** a test result indicating that the unborn child has Down syndrome;
  >       - **(ii)** a prenatal diagnosis that the unborn child has Down syndrome; or
  >       - **(iii)** any other reason to believe that the unborn child has or may have Down syndrome; or
  >     - **(B)** without first—
  >       - **(i)** asking the pregnant woman if she is aware of any test results, prenatal diagnosis, or any other evidence that the unborn child has or may have Down syndrome; and
  >       - **(ii)** if the woman is aware that the unborn child has or may have Down syndrome, informing the pregnant woman of the prohibitions on abortion under this section;

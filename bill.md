...
>     - **(A)** applications that include opportunities for peer support or peer mentoring, and make career coaching available, as part of the case management plan; and
>     - **(B)** applications that include a commitment to providing project participants with a monthly cash stipend equivalent to 50 percent of the Federal poverty level.

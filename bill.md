...
- **(a)** *Short title* This Act may be cited as the “Consumer Data Privacy and Security Act of 2021”.
...
- **(10)** *Pseudonymization* The term pseu­do­ny­mi­za­tion means the processing of personal data so that the personal data can no longer be attributed or reasonably linked to a specific individual without the use of additional information, provided that such additional information—
...
- **(g)** *Declination of requests*
  - **(1)** *In general* A covered entity—
    ...
    - **(B)** may decline to act on a request under this section where fulfilling the request would—
      ...
      - **(iii)** be contrary to the legitimate interests of the covered entity or a service provider of the covered entity, such as completing a transaction, repairing func­tion­al­i­ty or errors, or performing a contract between the covered entity and the individual;

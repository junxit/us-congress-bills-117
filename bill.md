...
Section 706 of the Telecommunications Act of 1996 (47 U.S.C. 1302)Section 13 of the Communications Act of 1934 (47 U.S.C. 163) is amended—

- **(1)** by redesignating subsection (d) as subsection (e); and
- **(2)** by inserting after subsection (c) the following:
  > - **(d)** *Status of telecommunications supply chain* As part of the inquiry required by subsection (b)In each report required by subsection (a), the Commission shall, to the extent that data is available, determine whether a lack of network equipment significantly impacted the deployment of advanced telecommunications capability during the applicable yearreporting period.

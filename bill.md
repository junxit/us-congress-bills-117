...
## § 3. Calculation of net earnings and total capital using GAAP

Section 7 of the Federal Reserve Act (12 U.S.C. 289 et seq.) is amended—

- **(1)** by redesignating the second subsection (b) (relating to the use of earnings transferred to the Secretary) and subsection (c) as subsections (c) and (d), respectively; and
- **(2)** by adding at the end the following:
  > - **(e)** *Calculation of net earnings and total capital using GAAP* For purposes of this section, net earnings and total capital shall be calculated in accordance with U.S. generally accepted accounting principles.

...
- **(a)** *In general* Section 7704(d)(1)(E) of the Internal Revenue Code of 1986 is amended—
  ...
  - **(3)** by striking “, or the transportation or storage” and all that follows and inserting the following:
    ...
    > - **(x)** the generation of electric power from, a qualifying gasification project (as defined in section 48B(c)(1) without regard to subparagraph (C)) that is described in section 48(d)(1)(B),
    ...
    >   - **(II)** the capture of carbon dioxide by such facility, or
    > - **(xii)** the production, storage, or transportation of any renewable chemical which—

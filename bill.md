...
- **(b)** *Exercise of rulemaking authority* This section is enacted by Congress—
  ...
  - **(2)** with full recognition of the constitutional right of the House of Representatives to change the rules (so far as relating to the procedure of the House) at any time, in the same manner, and to the same extent as in the case of any other rule of the House.

...
- **(g)** *Priority*
  ...
  - **(2)** *Tiers 2 and 3* In selecting applicants to receive grants under the pilot program under subparagraphs (B) and (C) of subsection (f)(2), the Administrator shall give priority to applicants—

...
## § 3. Improving digital identity task force
...
- **(f)** *Duties* The Task Force shall—
  ...
  - **(10)** to the extent practicable, seek input from and collaborate with interested parties in the private sector to carry out the purpose under subsection (b).
...
- **(e)** *Final publication* Not later than 1 year after the date of enactment of this Act, the Director shall publish a final version of the Framework.
...
- **(g)** *Authorization of appropriations* There is authorized to be appropriated to the Secretary of Commerce $10,000,000 for each of fiscal years 2022 through 2026 to carry out this Act.
...
- **(b)** *Use of funds* A State that receives a grant under this section shall use—
  ...
  - **(2)** not less than 10 percent of grant funds to provide services that assist individuals with obtaining identity credentials or identity verification services needed to obtain a digital driver’s license or digital State identity card.
...
## § 6. Report and recommendation on the use of social security numbers by nongovernmental organizations
...
## § 7. Security enhancements to Federal systems

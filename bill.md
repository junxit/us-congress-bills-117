...
## § 2. Treatment of certain liquidations of new motor vehicle inventory as qualified liquidations of LIFO inventory
...
- **(b)** *Additional relief*
  ...
  - **(2)** *Failure to fully replace liquidated vehicles during replacement period* If, as of the close of the replacement period, the taxpayer has failed to replace all liquidated vehicles with respect to a qualified liquidation to which paragraph (1) applies, the taxpayer shall increase gross income for the last taxable year of the replacement period by the sum of—
    - **(A)** the aggregate amount of income that would have been required to be recognized in the liquidation year had the taxpayer elected to apply the provisions of section 473 of the Internal Revenue Code of 1986 and not made the election in paragraph (1), plus
    - **(B)** interest thereon at the underpayment rate established under section 6621 of such Code.
  - **(3)** *Elections*

...
- **(2)** in subsection (b)—
  ...
  - **(B)** in paragraph (2)—
    ...
    - **(ii)** in subparagraph (G), by inserting “(including Tribes, Tribal organizations, and urban Indian organizations)” after “stakeholders”; and
...
- **(5)** by adding at the end the following:
  ...
  >   - **(1)** *Modifications* After consultation with Indian Tribes, the Secretary may make necessary and appropriate modifications to the program under subsections (b)(2), (g), and (i) to facilitate the use of the cooperative agreement program by eligible entities described in subsection (b)(1)(D).
  >   - **(2)** *Waivers*
  ...
  >         - **(III)** a list of any waived or alternative requirements of this section and the reasoning for issuing a waiver or alternative requirement; and
  >         - **(IV)** recommendations to the Congress for program modifications necessary to improve the implementation of the program with respect to eligible entities described in subsection (b)(1)(D); and

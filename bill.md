...
This Act may be cited as the “Fracturing Responsibility and Awareness of Chemicals Act of 2021”.
...
- **(b)** *Disclosure of hydraulic fracturing chemicals; medical emergencies; proprietary chemical formulas* Section 1421(b) of the Safe Drinking Water Act (42 U.S.C. 300h(b)) is amended by adding at the end the following:
  > - **(4)**
  >   - **(A)** Regulations included under paragraph (1)(C) shall include the following requirements:
  ...
  >   - **(B)** Subparagraph (A)(i) and (A)(ii) do not authorize the State (or the Administrator) to require the public disclosure of proprietary chemical formulas.

...
## § 2. Return information of certain tax-exempt organizations available in a searchable format
...
## § 3. Authority to disclose contributors to certain tax-exempt organizations
...
- **(b)** *Definitions* Section 6104(b) of such Code is amended—
  - **(1)** by striking “The information” and inserting the following:

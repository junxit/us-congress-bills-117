...
## § 2. Clarifying the eligibility for participation of peer support specialists in the furnishing of behavioral health integration services under the Medicare program
...
- **(b)** *Peer support specialist defined* For purposes of subsection (a), the term “peer support specialist” means an individual who—
  - **(1)** is recovering from a mental health or substance use condition; and

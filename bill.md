...
- **(b)** *Program*
  ...
  - **(3)** *Grants*
    ...
    - **(C)** *Food waste reduction projects* Under the program established under paragraph (1), the Administrator may award a grant to an eligible entity—
      - **(i)**
        - **(I)** to carry out or otherwise support a food waste reduction activity;
...
- **(e)** *Authorization of appropriations* There is authorized to be appropriated to carry out this section $650,000,000 for each of fiscal years 2022 through 2031, to remain available until expended.

...
## § 2. Continuation of coverage under a group health plan during a lock-out
...
- **(c)** *Penalties* Section 12 of the National Labor Relations Act (29 U.S.C. 162) is amended—
  ...
  - **(2)** by adding at the end the following:
    ...
    > - **(c)** *Considerations* In determining the amount of any civil penalty under subsection (b) or (d), the Board shall consider—

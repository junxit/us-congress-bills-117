...
## § 3. Intelligent transportation systems program advisory committee
...
- **(2)** in paragraph (2)—
  ...
  - **(F)** by inserting after subparagraph (M) (as so redesignated) the following:
    ...
    > - **(P)** an expert in traffic management;
...
## § 4. Smart community resource center
...
## § 5. Strengthening mobility and revolutionizing transportation grant program
...
## § 6. Electric vehicle working group
...
## § 7. National electric vehicle program
...
## § 9. State energy conservation plans
...
## § 10. Transportation workforce development

...
This Act may be cited as the “Transparency for Confucius Institutes Act”.

## § 2. Program participation agreements between institutions and Hanban
...
>   - **(A)** clearly delineates between the Confucius Institute's programs and the institution’s own Chinese language programs;
...
>   - **(C)** removes the Chinese assistant director position from the Confucius Institute;
>   - **(D)** subjects the staff and professors of the Confucius Institute to appropriate background checks;
>   - **(E)** is publicly available in its entirety online;
>   - **(F)** does not have a confidentiality section; and
>   - **(G)** provides that the institution has final decision-making authority, including with regard to conference themes, guest speakers, and topics for events on campus at the institution.

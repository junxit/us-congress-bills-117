...
## § 2. CMI testing of dementia care management
...
- **(1)** in subsection (b)(2)(B), by adding at the end the following new clause:
  > - **(xxviii)** Furnishing comprehensive care management services to eligible individuals with Alzheimer's disease or a related dementia through a Dementia Care Management Model, as described in subsection (h).
...
- **(2)** by adding at the end the following new subsection:
  ...
  >         - **(I)**
  >           - **(aa)** has 2 or more unplanned inpatient hospitalizations or visits to a hospital emergency department; or

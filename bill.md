...
- **(c)** *Central Intelligence Agency Museum*
  - **(1)** *In general* Following the award of the gold medal under subsection (a), the gold medal shall be given to the Central Intelligence Agency Museum, where it will be displayed as appropriate and made available for research.

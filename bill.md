...
- **(e)** *Definition of personally identifiable information* In this section, the term personally identifiable information—
  ...
  - **(2)** does not include a CAT-Order-ID or CAT-Reporter-ID, as such terms are defined in section 242.613(j) of title 17, Code of Federal Regulations (or successor regulations).

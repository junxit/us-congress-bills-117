...
Paragraph (2) of section 106(b) of the Child Abuse Prevention and Treatment Act (42 U.S.C. 5106a(b)) is amended—

- **(1)** in subparagraph (B)—
  - **(A)** by striking clauses (ii) and (iii); and
  - **(B)** by redesignating clauses (iv) through (xxv) as clauses (ii) through (xxiii), respectively; and
- **(2)** in subparagraph (D)—
  - **(A)** by redesignating clauses (i) through (vi) as clauses (iii) through (viii), respectively; and
  - **(B)** by inserting before clause (iii), as so redesignated:

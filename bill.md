...
- Whereas at least 15,000,000 new workers will be needed for the United States infrastructure in the next decade, including designing, building, and operating transportation, housing, utilities, and telecommunications;
- Whereas the COVID–19 pandemic has displaced millions of American workers and fundamentally shifted entire industries within foundational aspects of the economy, creating significant demands for high-quality and efficient upskilling and reskilling opportunities to ensure a quick and equitable recovery;
...
- Whereas over 11,000,000 students are enrolled in CTE across the country at the secondary and postsecondary levels, with CTE programs in thousands of CTE centers, comprehensive high schools, career academies, and CTE high schools, and nearly 1,000 2-year colleges;
...
- Whereas, according to an American Federation of Teachers poll, 96 percent of parents approve of expanding access to CTE and other programs that prepare students for jobs;

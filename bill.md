...
- **(1)** by amending paragraph (1) to read as follows:
  > - **(1)** *Uniformed services member consumer defined* In this subsection, the term uniformed services member consumer means a consumer who is a member of the uniformed services (as such term is defined under section 101(a) of title 10, United States Code).

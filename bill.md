...
- **(1)** in subsection (a)(5)—
  ...
  - **(B)** by adding at the end the following:
    ...
    >   - **(ii)** the sum of the amounts expended which are attributable to the offering, arranging, and furnishing (directly or on a contract basis) under the State plan (or waiver of the plan) of such services for the corresponding quarter in the four-quarter period ending on December 31, 2021, plus
...
- **(2)** in subsection (b), by adding at the end the following new paragraph:
  ...
  >     - **(iv)** *Postpartum and postpartum period* The terms postpartum and postpartum period each refer to the 1-year period beginning on the last day of the pregnancy of an individual.

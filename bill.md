...
- **(1)** in subsection (a)—
  ...
  - **(C)** by inserting after paragraph (87) the following new paragraph:
    > - **(88)** beginning January 1, 2023, not provide medical assistance with respect to a month to an able-bodied adult (as defined in subsection (tt)(2)) that has not met the work requirement described in subsection (tt)(1) for such month.

- **(2)** by adding at the end the following new subsection:
  > - **(tt)** *Work requirement for able-Bodied adults*

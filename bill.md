...
- **(2)** by inserting after subsection (f) the following:
  ...
  >   - **(2)** *Uniform standards* The Attorney General shall define uniform standards for the reporting of the information required under this subsection, including the form such reports shall take and the process by which such reports shall be shared with the Attorney General.
  ...
  >   - **(4)** *Covered offense defined* In this subsection, the term covered offense means any of the following:
  ...
  >     - **(H)** Arson.
  >     - **(I)** Any offense involving the illegal use of a firearm.
  >     - **(J)** Any offense involving the illegal possession of a firearm.

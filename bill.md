...
## § 1. Prohibition on restricting use of convertible virtual currency by a person to purchase goods or services for the person’s own use

- **(a)** *In general* No agency head may prohibit or otherwise restrict the ability of a covered user to—
...
- **(b)** *Definitions* In this section:
  - **(1)** *Convertible virtual currencies* A medium of exchange that—

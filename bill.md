...
This Act may be cited as the “Veterans Homecare Choice Act of 2022”.
...
- **(1)** in subsection (c)—
  ...
  - **(B)** by inserting after paragraph (4) the following new paragraph:
    > - **(5)** Any nurse registry, including any registered nurse, licensed practical nurse, certified nursing assistant, home health aide, companion, or homemaker furnishing services through a nurse registry.

- **(2)** in subsection (o), by adding at the end the following new paragraph:
  ...
  >   - **(B)** satisfies any applicable State licensure requirement.

...
This Act may be cited as the “Sunset Act of 2022”.
...
- **(2)** by adding at the end the following:
  ...
  >   - **(1)** *In general* Except as provided in this section, each major rule made by an agency shall cease to have effect—
  ...
  > - **(c)** *Exemption by President* The President may by Executive order exempt not more than one rule during each Congress from the application of subsection (a) for a period of not more than 30 days if the President determines, and submits to Congress written notice of such determination, that such rule is—
  ...
  > - **(d)** *Definition* In this section, the term “eligible rule” means a major rule that is in effect as of the date of enactment of this section.

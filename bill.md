...
- **(3)** in subsection (c), by inserting at the end the following new paragraph:
  > - **(4)** *Other exceptions* The entity described in subsection (a) can satisfy the requirements of paragraph (1)(A) with respect to an individual, if—
  ...
  >   - **(B)** such designated State unit fails to provide the relevant counseling, information, and referrals.
...
The amendments made by this Act shall apply with respect to the employment of an individual on or after March 13, 2020.

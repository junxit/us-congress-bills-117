...
- **(a)** *Findings* Congress finds the following:
  - **(1)** Carbon monoxide is a colorless, odorless gas produced by burning any fuel. Exposure to un­heal­thy levels of carbon monoxide can lead to carbon monoxide poisoning, a serious health condition that could result in death.

...
## § 2. National manufacturing extension partnership supply chain database
...
- **(i)** *Rules of construction*
  - **(1)** *Private entities* Nothing in this section shall be construed to require any private entity to share data with the Director specifically for the Database.

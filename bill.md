...
- **(7)** *Threat hunting* The term threat hunting means proactively and iteratively searching for threats to systems that evade detection by automated threat detection systems.
- **(8)** *Verification specification* The term verification specification means a specification developed under section 11331(f) of title 40, United States Code, as amended by this Act.

...
- **(1)** in section 921(a), by striking paragraph (24) and inserting the following:
  ...
  >     - **(i)** means, with respect to a firearm silencer or firearm muffler, an externally visible part of a firearm silencer or firearm muffler, without which a device capable of silencing, muffling, or diminishing the report of a portable firearm cannot be assembled; and
  >     - **(ii)** does not include any interchangeable parts designed to mount a firearm silencer or firearm muffler to a portable firearm.
...
- **(3)** in section 923(i)—
  - **(A)** by striking “Licensed” and inserting the following: “(1) In the case of a firearm other than a firearm silencer or firearm muffler, licensed”; and

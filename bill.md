...
- **(3)** by adding at the end the following new clause:
  > - **(vi)** includes, with respect to a year (beginning with 2022), any item or service—
  ...
  >   - **(II)** with respect to which the greatest total amount paid with respect to a physician speciality under the physician fee schedule under section 1848 for all such items or services furnished by physicians in such specialty during the previous year was less than $2,000,000.

...
## § 2. Safety valve for nonviolent youth
...
## § 3. Early release and home confinement for youth
...
- **(3)** in subsection (c), by amending paragraph (2) to read as follows:
  ...
  >   - **(D)** A prisoner placed on home confinement may not be ordered to pay the cost of electronic monitoring.
...
## § 4. Supervised release consideration for youth
...
## § 6. Specialized housing and programs for youth

...
- **(a)** *In general* Notwithstanding any other provision of law, for fiscal year 2023, the worldwide level of employment-based immigrants authorized under section 201(d) of the Immigration and Nationality Act (8 U.S.C. 1151(d)) shall be increased by the number computed under subsection (b) with respect to such worldwide levels.
...
- **(d)** *Availability* Each visa made available under this section shall remain available for use in fiscal year 2023 or in any subsequent fiscal year, until the Secretary of State, in consultation with the Secretary of Homeland Security, determines that such visa has been issued and used as the basis for an application for admission into the United States.

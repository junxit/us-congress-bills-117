...
- **(a)** *Approval required*
  ...
  - **(2)** *Initiation of Rule making and regulatory agenda* Except as provided in paragraph (3), any rule initiated under section 553 of title 5, United States Code, shall be initiated by a senior appointee.
  - **(3)** *Exception* Paragraph (1) or (2) does not apply if the head of an agency—
...
- **(b)** *Oversight*
  - **(1)** *Agency compliance* The head of each agency shall ensure that the issuance of any agency rule promulgated under section 553 of title 5, United States Code, adheres to the requirements of this section.

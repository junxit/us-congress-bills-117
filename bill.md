...
- **(a)** *In general* Section 5323(h) of title 49, United States Code, is amended—
  - **(1)** in paragraph (1) by inserting “or” after the semicolon;
  - **(2)** by striking paragraph (2); and
  - **(3)** by redesignating paragraph (3) as paragraph (2).
- **(b)** *No special rule* Section 5309 of such title is amended by—
  - **(1)** striking subsection (p); and
  - **(2)** redesignating subsection (q) as subsection (p).

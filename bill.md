  ...
  - **(1)** in subsection (c)(2)—
    - **(A)** in subparagraph (B)(i)—
      ...
      - **(iii)** by adding at the end the following new subclause:
        > - **(III)** subject to subparagraph (G), is a hospital described in subparagraph (F) and is certified on or after the date of the enactment of the Rural Hospital Closure Relief Act of 2021 by the State as being a necessary provider of health care services to residents in the area;
...
## § 3. CMI testing of new rural hospital delivery and payment model

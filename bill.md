...
This Act may be cited as the “Reverse Transfer Efficiency Act of 2021”.
...
- **(1)** in subparagraph (K)(ii), by striking “and” after the semicolon;
...
- **(3)** by inserting after subparagraph (L) the following:
  > - **(M)** an institution of postsecondary education in which the student was previously enrolled, to which records of postsecondary coursework and credits are sent for the purpose of applying such course­work and credits toward completion of a recognized postsecondary credential (as that term is defined in section 3 of the Workforce Innovation and Opportunity Act (29 U.S.C. 3102)), upon condition that the student provides written consent prior to receiving such credential.

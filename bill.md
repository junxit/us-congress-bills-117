...
This Act may be cited as the “Preserving Our Commitment to Homeless Veterans Act”.

## § 2. Staffing of program managers for supported housing program of Department of Veterans Affairs

- **(a)** *Staffing* Section 2003(b) of title 38, United States Code, is amended—
  - **(1)** by inserting “(1)” before “The Secretary”; and
  - **(2)** by adding at the end the following new paragraph:
    > - **(2)** The Secretary shall provide case management support whenever requested by a local housing authority under the program described in paragraph (1).
    > - **(3)**
    >   - **(A)** Except as provided in subparagraph (B), the Secretary shall ensure that in each fiscal year no case manager is concurrently assigned to more than 35 veterans under this subsection.

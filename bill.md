...
- **(d)** *Use of funds*
  ...
  - **(4)** *Limitation on statutory construction* Nothing in this subsection prohibits an eligible organization from receiving research or other funds under title 23 or 49, United States Code.
- **(e)** *Grant timing*
  - **(1)** *Request for application* Not later than 30 days after funds are made available to carry out this section for a fiscal year, the Secretary shall publish in the Federal Register a request for applications for grants under this section for that fiscal year.
  - **(2)** *Selection of grant recipients* Not later than 150 days after funds are made available to carry out this section for a fiscal year, the Secretary shall select grant recipients of grants under this section for that fiscal year.
- **(f)** *Federal share*
...
- **(j)** *Authorization of appropriations*
  - **(1)** *In general* There is authorized to be appropriated to the Secretary to carry out this section $500,000,000 for each of fiscal years 2022 through 2026.
  - **(2)** *Availability* The amounts made available to carry out this section shall remain available until expended.
- **(k)** *Definitions* In this Act:
  ...
  - **(9)** *Total project cost* The term total project cost means the sum total of all costs incurred in the development of an eligible project that are approved by the Secretary as reasonable and necessary, including—

...
- **(2)** by adding at the end the following:
  ...
  >   - **(D)** *Interest canceled* If a portion of a loan is canceled under this paragraph for any year, the entire amount of interest on such loan that accrues for such year shall be canceled.

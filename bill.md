...
- **(a)** *In general* Subtitle A of title XXII of the Homeland Security Act of 2002 (6 U.S.C. 651 et seq.) is amended by adding at the end the following new sections:
  > ## § 2220A. State and local cybersecurity grant program
  >
  ...
  >   - **(1)**
  >     - **(A)** the Cybersecurity Plan of the eligible entity or the Cybersecurity Plans of the eligible entities that comprise the multistate group; and
  ...
  >
  > ## § 2220B. Cybersecurity resource guide development for state, local, tribal, and territorial government officials
  >
...
## § 4. Title XXII technical and clerical amendments

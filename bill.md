...
- **(a)** *In general* Chapter 1 of title 23, United States Code, is amended by adding at the end the following new section:
  > ## § 171. Withholding of funds for providing identification cards to certain aliens
  >
  > - **(a)** *Withholding of funds for noncompliance* For fiscal year 2021 and each fiscal year thereafter, the Secretary shall withhold 100 percent of the amount required to be apportioned under each of sections 104(b)(1), 104(b)(3), and 104(b)(4) of this title to any State that is described in subsection (b).

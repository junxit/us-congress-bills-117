...
## § 2. Enhanced use lease pilot program
...
- **(h)** *Reporting*
  - **(1)** *Annual reports* Not later than January 31 of each year, the Administrator shall submit to the relevant congressional committees a report on the pilot program, including—
  ...
  - **(2)** *Final report* Not later than September 30, 2024, the Administrator shall submit to the relevant congressional committees a final report on the pilot program, including a recommendation on whether the pilot program should be extended.
- **(i)** *Duration*
  - **(1)** *In general* The authority to enter into leases under the pilot program shall expire on September 30, 2024.

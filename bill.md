...
This Act may be cited as the “No Social Security for Illegal Aliens Act of 2021”.
...
- **(1)** by striking “(19) Service” and inserting the following:
  > - **(19)**
  >   - **(A)** Service performed by an alien while employed in the United States for any period during which the alien is not authorized to be so employed;
  >   - **(B)** Service
...
- **(2)** in paragraph (6), by striking “him.” and inserting “him; or”; and

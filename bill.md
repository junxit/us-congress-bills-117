...
## § 2. Medicaid fallback coverage program for low-income adults in non-expansion States
...
- **(c)** *Health benefits coverage requirements* The requirements described in this subsection with respect to health benefits coverage are the following:
  ...
  - **(2)** *Premiums and cost sharing* No premiums are imposed for the coverage, and de­duct­i­bles, cost sharing, or similar charges may only be imposed in accordance with the requirements imposed on State Medicaid plans under section 1916 of the Social Security Act (42 U.S.C. 1396o).
...
## § 3. Increase and extension of temporary enhanced FMAP for States which begin to expend amounts for certain mandatory individuals

...
- **(a)** *In general* Section 487(a) of the Higher Education Act of 1965 (20 U.S.C. 1094(a)) is amended by adding at the end the following:
  > - **(30)**
  >   - **(A)** In the case of an institution that creates and distributes identification cards for students at any time after the date of enactment of this paragraph, such institution shall include phone contact information on each such card for the following organizations:

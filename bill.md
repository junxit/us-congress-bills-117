...
This Act may be cited as the “Feed Hungry Veterans Act of 2022”.
...
- **(1)** in section 3(j)(4)—
  - **(A)** by amending subparagraph (A) to read as follows:
    ...
    >   - **(ii)** two or more service-connected disabilities, at least one of which is rated at 40 percent or higher and the combined rating is 70 percent or higher under such title;

  - **(B)** by inserting after subparagraph (B) the following:
    > - **(C)** has a determination of being catastrophically disabled under such title; or
    > - **(D)** is under the age of 65 and receiving a pension under section 1521 of such title;

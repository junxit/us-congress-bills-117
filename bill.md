...
- **(1)** in subsection (e)—
  ...
  - **(C)** by inserting after paragraph (8) the following new paragraph:
    ...
    >   - **(D)** ensure that all visitors enjoy full and equal visitation privileges consistent with this paragraph; and
...
- **(2)** in subsection (f), by striking “(9)” and inserting “(10)”.

...
- **(c)** *Qualifications* Members of the Commission shall be appointed to the Commission from among individuals, or representatives of institutions or entities, who possess—
  - **(1)**
    - **(A)** a demonstrated commitment to the research, study, or promotion of Asian Pacific American history, art, political or economic status, or culture; and
    - **(B)**
...
- **(a)** *Reports*
  ...
  - **(2)** *Report on issues* The Commission shall submit to the President and Congress a report that addresses the following issues:
    ...
    - **(B)** The impact of the Museum on existing Asian Pacific American history-related museums.
    - **(C)** In consultation with the Smithsonian Institution, develop criteria for evaluating possible locations for the Museum in Washington, DC, and its environs.

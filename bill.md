...
- **(d)** *Definitions* In this section:
  ...
  - **(3)** *Measurable* The term measurable means, with respect to a chemical substance or class of chemical substances, capable of being measured using—
    - **(A)** test procedures established under section 304(h) of the Federal Water Pollution Control Act (33 U.S.C. 1314); or
    - **(B)** any other analytical method developed by the Administrator.

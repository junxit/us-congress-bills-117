...
## § 2. Maximum rate of interest on debts incurred before military service applicable to military dependents
...
- **(2)** in subsection (b)(1)—
  ...
  - **(B)** in subparagraph (A)—
    ...
    - **(ii)** by striking clause (i) and inserting the following:
      > - **(i)** military orders indicating the current, future, or past military duty status of the servicemember; or

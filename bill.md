...
- **(b)** *Numerical limitation* Section 214(g) of such Act (8 U.S.C. 1184(g)) is amended by adding at the end the following:
  > - **(12)**
  >   - **(A)** The Secretary of State may not approve a number of initial applications submitted for aliens described in section 101(a)(15)(E)(iv) that is more than the applicable numerical limitations set out in this paragraph.

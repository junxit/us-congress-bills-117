...
This Act may be cited as the “Expanding Markets for State-Inspected Meat Processors Act of 2021”.
...
- **(2)** in subsection (a)—
  ...
  - **(C)** in paragraph (1)(B) (as so designated)—
    ...
    - **(ii)** by adding at the end the following:
      ...
      >   - **(I)** *In general* Notwithstanding any other provision of this Act, the Secretary may allow, subject to subclause (III), the shipment in interstate commerce of carcasses, parts of carcasses, meat, and meat food products inspected under the State meat inspection program described in clause (i).
      ...
      >   - **(III)** *State-assigned official number*
      >     - **(aa)** *In general* Any establishment designated by a State to ship meat and meat food products pursuant to subclause (I) shall include in the labeling of such products the State-assigned official number that identifies the establishment and the State.
      >     - **(bb)** *Updated list* Each State with a State meat inspection program described in clause (i) shall submit, and update as necessary, to the Secretary a list of each such establishment and the corresponding State-assigned official number for such establishment.

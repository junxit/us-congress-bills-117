...
This Act may be cited as the “Educational Opportunity and Success Act of 2021”.

## § 2. Program authority and authorization of appropriations for Federal TRIO programs
...
- **(e)** *Outcome criteria* Section 402A(f) of the Higher Education Act of 1965 (20 U.S.C. 1070a–11(g)) is amended—
  - **(1)** in paragraph (1)—
    ...
    - **(B)** by striking “January 1, 2009” and inserting “the date of enactment of the Educational Opportunity and Success Act of 2021”; and
  ...
  - **(2)** in paragraph (3)—
    - **(A)** in subparagraph (A)—
      ...
      - **(iii)** inserting after clause (iv), the following:
    ...
    - **(B)** in subparagraph (B)—
      ...
      - **(iv)** inserting after clause (v), the following:
    ...
    - **(F)** by amending subparagraph (E), as redesignated by subparagraph (C), to read as follows:
      ...
      >   - **(v)** the entity’s objective regarding the attainment of doctoral degrees by former program participants within 10 years of receiving the baccalaureate degree.
...
## § 4. Postbaccalaureate achievement program authority

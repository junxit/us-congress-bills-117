...
- **(a)** *In general* Subpart C of part IV of subchapter A of chapter 1 of the Internal Revenue Code of 1986 is amended by inserting after section 36B the following new section:
  ...
  > - **(e)** *Termination* This section shall not apply to taxable years beginning after December 31, 2024.

- **(b)** *Advance payment* Chapter 77 of the Internal Revenue Code of 1986 is amended by inserting after section 7527 the following new section:
  > ## § 7527A. Advance payment of middle class tax credit
  >
  > - **(a)** *In general* Not later than 6 months after the date of the enactment of the Rent Relief Act of 2022, the Secretary shall establish a program for making advance payments of the credit allowed under section 36C on a monthly basis to any taxpayer who—
...
- **(c)** *Clerical amendments*
  ...
  - **(2)** *Advance payment* The table of sections for chapter 77 of such Code is amended by inserting after the item relating to section 7527 the following new item:

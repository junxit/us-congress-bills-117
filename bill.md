...
This Act may be cited as the “Small Business Payment for Performance Act of 2022”.

## § 2. Equitable adjustments to construction contracts

- **(a)** *In general* Section 15 of the Small Business Act (15 U.S.C. 644) is amended—
  - **(1)** by redesignating subsection (x) as subsection (y); and
  - **(2)** by inserting after subsection (w) the following new subsection:
...
- **(b)** *Implementation* The Administrator of the Small Business Administration shall implement the requirements of this section not later than the earlier of the following dates:
  - **(1)** The first day of the first full fiscal year beginning after the date of the enactment of this Act.
  - **(2)** October 1, 2024.

...
>   - **(A)** *Offense*
>     - **(i)** *In general* Except as provided in clause (ii), it shall be unlawful for a person to knowingly store or keep any firearm that has moved in, or that has otherwise affected, interstate or foreign commerce on the premises of a residence under the control of the person if—
...
>   - **(B)** *Penalty* Whoever violates subparagraph (A) shall be fined under this title, imprisoned for not more than 5 years, or both.

...
- **(2)** by inserting after section 48 the following new section:
  ...
  >   - **(2)** *Distribution*
  >     - **(A)** *Administrator* The Administrator shall distribute the resource guide required under subsection (a) to offices within the Administration, including district offices, and to the persons consulted under subsection (c).

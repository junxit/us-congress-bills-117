...
- **(3)** *States* The term States means each of the States of Virginia and North Carolina.
- **(4)** *Study area* The term study area means—
  ...
  - **(D)** any other areas in the States that—
    - **(i)** have heritage aspects that are similar to the areas described in subparagraph (A), (B), or (C); and
...
- **(b)** *Requirements* The study shall include analysis, documentation, and determinations on whether the study area—
  ...
  - **(5)** includes residents, business interests, nonprofit organizations, State, local, and Tribal governments, and other appropriate entities that—

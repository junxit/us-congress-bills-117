...
This Act may be cited as the “Demand-Response Management Act of 2021”.

## § 2. Purpose

The purpose of this Act is to promote the use of demand-response technology and practices that support grid resiliency and reliability during extreme weather events.

## § 3. Promotion of demand-response practices
  ...
  - **(2)** *Compliance*
    ...
    - **(C)** *Prior State actions*
      ...
      - **(ii)** *Cross-reference* Section 124 of the Public Utility Regulatory Policies Act of 1978 (16 U.S.C. 2634) is amended—
        ...
        - **(II)** by adding at the end the following: “In the case of the standard established by paragraph (20) of section 111(d), the reference contained in this section to the date of enactment of this Act shall be deemed to be a reference to the date of enactment of that paragraph (20).”.

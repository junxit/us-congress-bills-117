...
- **(b)** *Requirements*
  - **(1)** *National securities exchanges*
    ...
    - **(B)** *Effective date; applicability* The amendment made by subparagraph (A) shall—
      ...
      - **(ii)** apply with respect to a covered entity, the securities of which are listed on a national securities exchange on or after the date described in clause (i).
